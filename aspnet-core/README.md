...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p c432f18d-dc8b-456c-b1e2-531fa3db6875
```

> `c432f18d-dc8b-456c-b1e2-531fa3db6875` is the password of the certificate, you can change it to any password you want.
...
Run `SmartPantry.DbMigrator` to create the initial database. This should be done in the first run. It is also needed if a new database migration is added to the solution later.
